...
{
    public class GetLoanInstallmentByIdQuery : IRequest<LoanInstallmentViewModel>
    {
        public int Id { get; set; }
    }

    public class GetLoanInstallmentByIdQueryHandler : IRequestHandler<GetLoanInstallmentByIdQuery, LoanInstallmentViewModel>
    {
        ...
        public async Task<LoanInstallmentViewModel> Handle(GetLoanInstallmentByIdQuery query, CancellationToken cancellationToken)
        {
            var entity = await _repository.GetByIdAsync(query.Id);
            if (entity == null) throw new Exception("LoanInstallment not found with this id");

            return _mapper.Map<LoanInstallmentViewModel>(entity);
        }
    }
}
