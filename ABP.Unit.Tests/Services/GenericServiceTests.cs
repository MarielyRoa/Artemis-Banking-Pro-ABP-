...
namespace ABP.Unit.Tests.Services
{
    ...
    public class GenericServiceTests
    {
        ...
        {
            // Arrange
            _mockRepo.Setup(r => r.GetByIdAsync(99)).ReturnsAsync((DummyEntity?)null);
        ...
        public async Task GetAll_Should_Return_List_Of_Dtos()
        {
            ...
            _mockRepo.Setup(r => r.GetAllListAsync()).ReturnsAsync(entities);
        ...
        {
            // Arrange
            _mockRepo.Setup(r => r.GetAllListAsync()).Throws(new Exception("Query failed"));
