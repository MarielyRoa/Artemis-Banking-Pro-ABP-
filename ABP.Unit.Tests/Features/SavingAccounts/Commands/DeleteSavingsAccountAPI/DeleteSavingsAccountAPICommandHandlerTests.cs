...
namespace ABP.Unit.Tests.Features.SavingAccounts.Commands.DeleteSavingsAccountAPI
{
    public class DeleteSavingsAccountAPICommandHandlerTests
    {
        private readonly DbContextOptions<ArtemisBankingAppContext> _dbOptions;

        public DeleteSavingsAccountAPICommandHandlerTests()
        {
            _dbOptions = new DbContextOptionsBuilder<ArtemisBankingAppContext>()
                .UseInMemoryDatabase($"TestDb_DeleteSavingsAccountAPICommandHandler_{Guid.NewGuid()}")
                .Options;
        }
        ...
        public async Task Handle_Should_Return_Expected_Result_When_Successful()
        {
            ...
            var handler = new DeleteSavingsAccountAPICommandHandler(mocksavingAccountService.Object, mocktransactionService.Object);
            var request = new DeleteSavingsAccountAPICommand();
