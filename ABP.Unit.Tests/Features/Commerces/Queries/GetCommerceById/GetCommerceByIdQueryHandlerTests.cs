    ...
    public class GetCommerceByIdQueryHandlerTests
    {
        ...
        public GetCommerceByIdQueryHandlerTests()
        {
            _dbOptions = new DbContextOptionsBuilder<ArtemisBankingAppContext>()
                .UseInMemoryDatabase($"TestDb_GetCommerceByIdQueryHandler_{Guid.NewGuid()}")
                .Options;
        }
        ...
        public async Task Handle_Should_Return_Expected_Result_When_Successful()
        {
            ...
            var handler = new GetCommerceByIdQueryHandler(mockcommerceRepository.Object, mockuserManager.Object);
            var request = new GetCommerceByIdQuery();
