    ...
    public class GetCreditCardByIdQueryHandlerTests
    {
        ...
        public GetCreditCardByIdQueryHandlerTests()
        {
            _dbOptions = new DbContextOptionsBuilder<ArtemisBankingAppContext>()
                .UseInMemoryDatabase($"TestDb_GetCreditCardByIdQueryHandler_{Guid.NewGuid()}")
                .Options;
        }
        ...
        public async Task Handle_Should_Return_Expected_Result_When_Successful()
        {
            ...
            var handler = new GetCreditCardByIdQueryHandler(mockcreditCardService.Object, mocktransactionService.Object);
            var request = new GetCreditCardByIdQuery();
