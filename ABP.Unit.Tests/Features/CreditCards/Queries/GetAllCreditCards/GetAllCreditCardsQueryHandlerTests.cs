...
namespace ABP.Unit.Tests.Features.CreditCards.Queries.GetAllCreditCards
{
    public class GetAllCreditCardsQueryHandlerTests
    {
        ...
        public GetAllCreditCardsQueryHandlerTests()
        {
            _dbOptions = new DbContextOptionsBuilder<ArtemisBankingAppContext>()
                .UseInMemoryDatabase($"TestDb_GetAllCreditCardsQueryHandler_{Guid.NewGuid()}")
                .Options;
        }
        ...
        public async Task Handle_Should_Return_Expected_Result_When_Successful()
        {
            ...
            var handler = new GetAllCreditCardsQueryHandler(mockcreditCardService.Object, mockuserManager.Object);
            var request = new GetAllCreditCardsQuery();
